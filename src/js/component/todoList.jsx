...
const Tasklist = () => {
	...
	const DeleteTarea = (nombre) => {
		confirm("¿ Vas a eliminar esta tarea ?");
	...
	return (
		<>
			<div className="container justify-content-center text-center mt-5">
				<h1>
					TodoList whit React and Fetch <i className="fab fa-react fa-lg"></i>
				</h1>
				<input
					value={task}
					type="text"
				...
				<div id="listContainer" className="container my-2 py-4">
					...
					<div className="footer pt-2">
						<h5>
							Tienes {listOfTasks.length} {""}Estas son tus tareas pendientes
						</h5>
					</div>
				</div>
			</div>
